...
public record CourseDto(String id, String title, String text, List<Explanation> explanations, List<String> links, String username, LanguageType languageType, JapaneseLevels japaneseLevels, LocalDateTime createAt, LocalDateTime updatedAt, boolean published) {
}