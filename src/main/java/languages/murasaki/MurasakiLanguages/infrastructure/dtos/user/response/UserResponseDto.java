package languages.murasaki.MurasakiLanguages.infrastructure.dtos.user.response;
...
public record UserResponseDto(String id, String name, String username, String email, String icon, String background,
