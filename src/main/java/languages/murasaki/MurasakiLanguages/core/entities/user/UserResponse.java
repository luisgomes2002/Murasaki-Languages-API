...
public record UserResponse(String id, String name, Gender gender, LocalDate birth, String username, String email, String icon, String background,
                           ...
                           boolean isEnabled, boolean isBanned, SubscriptionType subscription) implements Serializable {
}
