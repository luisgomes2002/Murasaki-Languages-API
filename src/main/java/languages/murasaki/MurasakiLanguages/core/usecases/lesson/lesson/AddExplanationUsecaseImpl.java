...
public class AddExplanationUsecaseImpl implements AddExplanationUsecase{

    private final LessonGateway lessonGateway;
    private final AuthenticatedUsecase authenticatedUsecase;

    public AddExplanationUsecaseImpl(LessonGateway lessonGateway, AuthenticatedUsecase authenticatedUsecase) {
    ...
    public void execute(String lessonId, String explanationId) {
        ...
        lessonGateway.addExplanation(lessonId, explanationId);
    }
}
