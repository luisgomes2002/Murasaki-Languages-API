...
public class RemoveWorksheetsUsecaseImpl implements RemoveWorksheetsUsecase {

    private final LessonGateway lessonGateway;
    private final AuthenticatedUsecase authenticatedUsecase;

    public RemoveWorksheetsUsecaseImpl(LessonGateway lessonGateway, AuthenticatedUsecase authenticatedUsecase) {
        this.lessonGateway = lessonGateway;
        this.authenticatedUsecase = authenticatedUsecase;
    }

    @Override
    public void execute(String lessonId, String worksheetId) {
        ...
        lessonGateway.removeWorksheets(lessonId, worksheetId);
    }
}
