...
public class AddWorksheetsUsecaseImpl implements AddWorksheetsUsecase{

    private final LessonGateway lessonGateway;
    private final AuthenticatedUsecase authenticatedUsecase;

    public AddWorksheetsUsecaseImpl(LessonGateway lessonGateway, AuthenticatedUsecase authenticatedUsecase) {
    ...
    public void execute(String lessonId, String worksheetId) {
        ...
        lessonGateway.addWorksheets(lessonId, worksheetId);
    }
}
